        ...
        <div className='bg-base-300'>
            <footer className="footer p-10  text-base-content">
                <div>
                    ...
                    <Link to='/' className="link link-hover">Ram</Link>
                    <Link to='/' className="link link-hover">SSD</Link>
                    <Link to='/' className="link link-hover">CD ROOM</Link>
                ...
                <div>
                    ...
                    <Link to='/' className="link link-hover">Team member</Link>
                </div>
                <div>
            ...
            <div className='p-5 text-center'>
                <p>Copyright © 2022 - All right reserved sympole computer parts</p>
            </div>
        </div>
    );
};
