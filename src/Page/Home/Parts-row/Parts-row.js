        ...
        <div>
            <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                <div
                    ...
                    <img style={{ "width": "100%", "height": "248px" }}
                        src={image}
                        alt="Post-img" />
                    <div
                ...
                <div>
                    <p class="text-red-500 transition-all ms-7 font-sans text-xl font-medium leading-snug tracking-normal">Price: {price}$</p>
                </div>
                <div class="p-6 pt-3">
                    <Link to={`/Purchase/${_id}`}
                        class="block select-none rounded-lg bg-gray-900 py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button">
                        BUY NOW
                    </Link>
